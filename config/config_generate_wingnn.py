...
def generate_full_config(params: dict) -> dict:
    ...
    return {
        ...
        "dataset": {
            ...
            "task_splitting": params.get("task_splitting", "temporal"),
            "split": params.get("split", [0.7, 0.3]),
            "edge_encoder": True,
        ...
        "train": {
            "mode": params.get("train_mode", "windows_topo"),
            "epoch_resume": -1,
            "ckpt_clean": True,
        ...
        "model": {
            "type": params.get("model_type", "wingnn"),
        ...
        "gnn": {
            ...
            "layer_type": params.get("layer_type", "windows_gcn"),
            "batchnorm": True,
            "act": "prelu",
            "dropout": 0.0,
            "agg": "add",
        ...
        "optim": {
            ...
            "momentum": 0.9,
            "scheduler": "cos",
            "meta_lr": params.get("meta_lr", 0.005),
        ...
        "windows": {
            ...
            "maml_lr": params.get("maml_lr", 0.5),
        ...
        "topo": {
            ...
            "drop_rate": params.get("drop_rate", 0.5),
            "image_type": params.get("image_type", "topo"),
        }
    }
...
def generate_configs(output_dir: str = "config"):
    ...
    remarks = ['as_topo', 'alpha_topo', 'otc_topo', 'uci_topo', 'body_topo', 'title_topo', 'eth_topo']
    os.makedirs(os.path.join(output_dir, "wingnn_example"), exist_ok=True)
    for remark in remark_list:
        ...
        filepath = os.path.join(output_dir, "wingnn_example", filename)
